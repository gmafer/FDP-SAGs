...
DATA_DIR=seq1/data/clean/quast_busco_tiara/busco_c/
OUT_FILE=seq1/data/clean/quast_busco_tiara/busco_c/busco_c_report.txt
...
DATA_DIR=seq1/data/clean/quast_busco_tiara/tiara_c/
OUT_FILE=seq1/data/clean/quast_busco_tiara/tiara_c/tiara_c_report.txt
...
## reformat with R
# library(tidyverse)
# report <- read_tsv('seq1/data/tiara/tiara_report.txt', col_names = c('Sample','Result'))
...
# write_tsv(new_report, 'seq1/data/tiara/tiara_report_format.txt')

DATA_DIR=seq1/data/clean/quast_busco_tiara/quast_c/
OUT_FILE=seq1/data/clean/quast_busco_tiara/quast_c/quast_c_report.txt
