...
#SBATCH --account=emm2
#SBATCH --job-name=blast_ill_manual_clean_sag
...
blastn \
 ...
 -perc_identity 90 \
 -query ../../../easig_metaG/illumina/data/clean/assembly_all/GC112012/scaffolds.fasta \
...
echo -e "query_id\tsubject_id\t%_identity\taln_len\tq_start\tq_end\ts_start\ts_end\te_value\tseq_title\tseq_len\tq_len" | cat - ${OUT_DIR}/${SAMPLE}.out > ${OUT_DIR}/${SAMPLE}_HDR.out
