...
#SBATCH --account=emm2
#SBATCH --job-name=mmseqtax
#SBATCH --ntasks=1
#SBATCH --mem=200G
#SBATCH --cpus-per-task=10
#SBATCH --error=data/logs/taxeuk.%J.err
#SBATCH --output=data/logs/taxeuk.%J.out
...
#DB_DIR='/mnt/lustre/bio/shared/ecomics/databases/eukaryotic/TAX_DBs/EukProt.tax'
DB_DIR='/mnt/biostore/bio/flatorre/EukProt.tax'

EP='data/clean/eukProt'

TMP_DIR=${EP}/tempF/TAX_DBs

AA='data/clean/metaeuk/GC1003827_A03_metaeuk.output/GC1003827_A03_TARA_pred.exons.fasta'
