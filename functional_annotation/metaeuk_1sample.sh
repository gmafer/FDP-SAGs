...
#REF_DB=/mnt/biostore/bio/flatorre/MERC.MMETSP.uniclust50/MMETSP_uniclust50_MERC_profiles
REF_DB='/mnt/lustre/scratch/guillem/MERC.MMETSP.uniclust50/MMETSP_uniclust50_MERC_profiles'
#REF_DB=/mnt/lustre/scratch/guillem/MERC.MMETSP.uniclust50
TEMP=./tempF
