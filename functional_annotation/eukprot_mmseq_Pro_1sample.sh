...
#SBATCH --account=emm2
#SBATCH --job-name=mmseqtaxpro1
#SBATCH --ntasks=1
#SBATCH --mem=200G
#SBATCH --cpus-per-task=10
#SBATCH --error=data/logs/taxeuk_pro1_%A_%a.err
#SBATCH --output=data/logs/taxeuk_pro1_%A_%a.out
...
EP='data/clean/eukProt_Pro_1sample'
...
mmseqs taxonomy --search-type 1 --threads 10 --lca-ranks "species,genus,family,order,class,phylum,superkingdom" \
        ${OUT_DB}/aa_TARA_db  \
        ${DB_DIR}/gtdb_54kDB ${OUT_TAX}/taxEukMPGC.EukProt.TARA.db ${TMP_DIR}/${OUT_TMP}
